...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private boolean isShowSuggestion = false;
    ...
    private void initiateView() {
        ...
        mSearchLayoutHeight = mSearchLayout.getLayoutParams().height;
    ...
    public void setSearchLayoutHeight(int height){
        this.mSearchLayoutHeight = height;
        mSearchLayout.getLayoutParams().height = height;
        mSearchTopBar.getLayoutParams().height = height;
    }

    public void isShowDefaultSuggestion(boolean isShowSuggestion){
        this.isShowSuggestion = isShowSuggestion;
    }

    public boolean isShowDefaultSuggestion(){
    ...
    public void showSuggestions() {
        if (mAdapter != null && mAdapter.getCount() > 0 && mSuggestionsListView.getVisibility() == GONE) {
            ...
            View listItem = mAdapter.getView(0, null, mSuggestionsListView);
            listItem.measure(0, 0);
            int totalHeight = listItem.getMeasuredHeight();
            DisplayMetrics displayMetrics = new DisplayMetrics();
            ((Activity) getContext()).getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);
            int screenHeight = displayMetrics.heightPixels;
            if((totalHeight * mAdapter.getCount()) + mSearchLayoutHeight > (screenHeight /2)){
                mSearchLayout.getLayoutParams().height = screenHeight /2;
            }else{
                mSearchLayout.getLayoutParams().height = (totalHeight * mAdapter.getCount()) + mSearchLayoutHeight;
            }
        }
    }
    ...
    public void dismissSuggestions() {
        mSearchLayout.getLayoutParams().height = mSearchLayoutHeight;
